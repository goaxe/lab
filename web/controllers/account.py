# -*- coding: UTF-8 -*-
from flask import Blueprint, render_template, request, jsonify, flash, g, abort, redirect, url_for
...
def manage():
    ...
    return render_template('admin/manage.html', page_name='manage_dp', department_form=department_form,
